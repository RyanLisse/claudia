...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A flexible input component with support for labels, descriptions, error states, icons, and addons. Fully accessible with WCAG 2.1 AA compliance.',
      },
    },
  },
  tags: ['autodocs'],
...
export const PasswordToggle: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example of a password input with show/hide toggle functionality.',
      },
    },
  },
}
