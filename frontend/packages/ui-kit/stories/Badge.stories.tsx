...
import { Check, Clock, Star, User } from "lucide-react";
...
const meta = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					"Display status, labels, or small pieces of information with visual emphasis.",
			},
		},
	},
	tags: ["autodocs"],
...
export const StatusBadges: Story = {
	render: () => (
		<div className="space-y-4">
			<div>
				<h4 className="mb-2 font-medium text-sm">Order Status</h4>
			...
			<div>
				<h4 className="mb-2 font-medium text-sm">User Roles</h4>
				<div className="flex gap-2">
			...
			<div>
				<h4 className="mb-2 font-medium text-sm">Priority Levels</h4>
				<div className="flex gap-2">
...
export const InteractiveBadges: Story = {
	render: () => {
		...
		return (
			<div className="space-y-4">
				<div>
					<h4 className="mb-2 font-medium text-sm">Tech Stack</h4>
					<div className="flex flex-wrap gap-2">
						{tags.map((tag) => (
							<Badge key={tag} removable variant="outline" onRemove={() => {}}>
								{tag}
							</Badge>
						))}
					</div>
				...
				<div>
					<h4 className="mb-2 font-medium text-sm">Notifications</h4>
					<div className="flex gap-2">
						<Badge
							variant="destructive"
						...
						<Badge
							variant="warning"
							className="cursor-pointer transition-colors hover:bg-yellow-600"
							onClick={() => {}}
						>
							5 Warnings
						</Badge>
