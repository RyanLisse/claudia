...
import { useUIStore, useAppStore, useAuthStore, useSyncStore } from '@/stores';
import { useCreateProjectMutation, useUpdateProjectMutation } from '@/hooks/use-optimistic-mutations';
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold">Frontend State Management Demo</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Theme, sidebar, notifications, loading states</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {notifications.slice(0, 2).map((notification) => (
                <Badge key={notification.id} variant="secondary" className="text-xs">
                  {notification.title}
                </Badge>
              ))}
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Projects, agents, workspace settings</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <div className="flex justify-between items-center">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div className="flex items-center space-x-1">
                  <Switch 
                    ...
                    onCheckedChange={(checked) => updateWorkspaceSettings({ autoSave: checked })}
                    size="sm"
                  />
                  <span>Auto-save</span>
                </div>
                <div className="flex items-center space-x-1">
                  <Switch 
                    ...
                    onCheckedChange={(checked) => updateWorkspaceSettings({ gitIntegration: checked })}
                    size="sm"
                  />
                  <span>Git</span>
                </div>
            ...
            {user && (
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-1 text-xs">
                  ...
                  <span>Notifications: {user.preferences.notifications ? 'On' : 'Off'}</span>
                  <span>Email: {user.preferences.emailUpdates ? 'On' : 'Off'}</span>
                </div>
              </div>
            )}
          </CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <div className={`w-3 h-3 rounded-full ${getSyncStatusColor(syncStatus)}`} />
            ...
            {conflicts.length > 0 && (
              <div className="space-y-2">
                ...
                {conflicts.slice(0, 2).map((conflict) => (
                  <Badge key={conflict.id} variant="destructive" className="text-xs">
                    {conflict.table}
                  </Badge>
                ))}
              </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <div className={`w-3 h-3 rounded-full ${isFullySynced ? 'bg-green-500' : 'bg-yellow-500'}`} />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>TanStack Query with optimistic updates</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <span className="text-sm font-medium">Active Mutations</span>
              <div className="space-y-1">
            ...
            <Button
              ...
              variant="outline"
              onClick={() => {
                toast.info('This demo showcases the integration of TanStack Query, Zustand, and ElectricSQL for optimal frontend state management!');
              }}
            >
              About Integration
            </Button>
