...
import { useOptimisticMutation, useCreateProjectMutation } from '@/hooks/use-optimistic-mutations';
...
describe('useCreateProjectMutation', () => {
  ...
  it('should handle project creation failure', async () => {
    ...
    expect(mockSyncStore.revertOptimisticUpdate).toHaveBeenCalled();
    expect(toast.error).toHaveBeenCalledWith('Failed to create project', expect.any(Object));
  });
